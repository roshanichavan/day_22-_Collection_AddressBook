...
class Book {
	...
	public void searchByCity() {
		...
		Person p = new Person(city, city, city, city, city, city, city, city);
	...
	public void sortByFirstName() {
		...
		List<Person> sortedFirstNameList = book.stream().sorted((n1, n2) -> n1.firstname.compareTo(n2.firstname))
				.collect(Collectors.toList());
		System.out.println("Sorted Contacts In Address Book By Name: " + sortedFirstNameList);
	}

	void sortByState() {
		List<Person> sortedStateList = book.stream().sorted((n1, n2) -> n1.state.compareTo(n2.state))
				.collect(Collectors.toList());
